...
const Page = () => {
    ...
    return <div className="bg-white items-center justify-center gap-10 pt-20 pb-8 w-full mx-auto z-50">
        {loading ? (
            <div className="w-full min-h-screen items-center h-full flex-col  flex">
                <LoadingSpinner />
            </div>
        ) : (
